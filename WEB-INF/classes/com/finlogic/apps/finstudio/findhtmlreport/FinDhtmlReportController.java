...
import com.finlogic.util.findhtmlreport.FinDhtmlReportDirectConnection;
 ...
 * @author njuser
 */
public class FinDhtmlReportController extends MultiActionController
{

    private final FinDhtmlReportService service = new FinDhtmlReportService();
    private final FinDhtmlReportDirectConnection conn = new FinDhtmlReportDirectConnection();
    ...
    public ModelAndView setFinReport(final HttpServletRequest request, final HttpServletResponse response)
    {
        ...
        try
        {
            ...
            mav.setViewName("findhtmlreport/main");
        }
        catch (Exception e)
        {
    ...
    public ModelAndView setFinish(final HttpServletRequest request, final HttpServletResponse response, final FinDhtmlReportFormBean formBean)
    {
        ModelAndView mav = new ModelAndView();
        mav.setViewName("findhtmlreport/ProjectModuleSpecification");
        try
        {
    ...
    public ModelAndView checkQuery(final HttpServletRequest request, final HttpServletResponse response, final FinDhtmlReportFormBean formBean) throws SQLException
    {
        ModelAndView mav = new ModelAndView();
        mav.setViewName("findhtmlreport/ProjectModuleSpecification");
        Connection con = null;
        ...
        {
            String str, query;
            query = formBean.getTxtQuery()[Integer.parseInt(formBean.getQueryIndex())].trim();
            if (query.endsWith(";"))
            {
                query = query.substring(0, query.length() - 1).trim();
            }
            query = "SELECT * FROM (" + query + ") X WHERE 1 = 2";

            if ("usingAlias".equals(formBean.getRdoConType()))
            {
                str = service.validateQuery(formBean.getCmbAliasName()[Integer.parseInt(formBean.getQueryIndex())], query, formBean.getRdoConType(), null);
            }
            else
            {
                //direct connection                
                con = conn.getConnection(formBean.getCmbDevServer());
                str = service.validateQuery(formBean.getCmbAliasName()[Integer.parseInt(formBean.getQueryIndex())], query, formBean.getRdoConType(), con);
            }
    ...
    public ModelAndView getColumnDetail(final HttpServletRequest request, final HttpServletResponse response, final FinDhtmlReportFormBean formBean) throws SQLException
    {
        ModelAndView mav = new ModelAndView();
        Connection con = null;
        try
        {
            ...
            {
                String query = formBean.getTxtQuery()[i].trim();
                if (query.endsWith(";"))
                {
                    query = query.substring(0, query.length() - 1).trim();
                }
                ...
                if ("usingAlias".equals(formBean.getRdoConType()))
                {
                    colDeatilsMap = service.getColumnDetail(formBean.getCmbAliasName()[i], query, formBean.getRdoConType(), null);
                }
                else
                {
                    //direct connection
                    con = conn.getConnection(formBean.getCmbDevServer());
                    colDeatilsMap = service.getColumnDetail(formBean.getCmbAliasName()[i], query, formBean.getRdoConType(), con);
                }
    ...
    public ModelAndView getColumnNames(final HttpServletRequest request, final HttpServletResponse response, final FinDhtmlReportFormBean formBean) throws SQLException
    {
        ModelAndView mav = new ModelAndView();
        Connection con = null;
        try
        {
            List colNames;
            String query = formBean.getTxtQuery()[Integer.parseInt(formBean.getQueryIndex())].trim();
            if (query.endsWith(";"))
            {
                query = query.substring(0, query.length() - 1).trim();
            }
            ...
            if ("usingAlias".equals(formBean.getRdoConType()))
            {
                colNames = service.getColumnNames(formBean.getCmbAliasName()[Integer.parseInt(formBean.getQueryIndex())], query, formBean.getRdoConType(), null);
            }
            else
            {
                //direct connection
                con = conn.getConnection(formBean.getCmbDevServer());
                colNames = service.getColumnNames(formBean.getCmbAliasName()[Integer.parseInt(formBean.getQueryIndex())], query, formBean.getRdoConType(), con);
            }
    ...
    public ModelAndView comboFillCheckQuery(final HttpServletRequest request, final HttpServletResponse response, final FinDhtmlReportFormBean formBean) throws SQLException
    {
        ModelAndView mav = new ModelAndView();
        mav.setViewName("findhtmlreport/ProjectModuleSpecification");
        Connection con = null;
        ...
        {
            String str, query;
            query = formBean.getFltrTxtSrcQuery().trim();
            if (query.endsWith(";"))
            {
                query = query.substring(0, query.length() - 1).trim();
            }
            ...
            if ("usingAlias".equals(formBean.getRdoConType()))
            {
                str = service.validateQuery(formBean.getCmbAliasName()[0], query, formBean.getRdoConType(), null);
            }
            else
            {
                //direct connection                
                con = conn.getConnection(formBean.getCmbDevServer());
                str = service.validateQuery(formBean.getCmbAliasName()[0], query, formBean.getRdoConType(), con);
            }
            mav.addObject("process", "check");
            if (str.contains("Invalid Query"))
            {
    ...
    public ModelAndView getRefNumber(final HttpServletRequest request, final HttpServletResponse response, final FinDhtmlReportFormBean formBean) throws SQLException, ClassNotFoundException
    {
        ModelAndView mav = new ModelAndView();
        try
        {
    ...
    public ModelAndView getWsDetails(final HttpServletRequest request, final HttpServletResponse response, final FinDhtmlReportFormBean formBean)
    {
        ModelAndView mav = new ModelAndView();
        try
        {
    ...
    public ModelAndView getWsMethods(final HttpServletRequest request, final HttpServletResponse response, final FinDhtmlReportFormBean formBean)
    {
        ModelAndView mav = new ModelAndView();
        try
        {
    ...
    public ModelAndView getWsMethodParams(final HttpServletRequest request, final HttpServletResponse response, final FinDhtmlReportFormBean formBean)
    {
        ModelAndView mav = new ModelAndView();
        try
        {
