 ...
 * @author njuser
 */
public class FinDhtmlReportFormBean
{
    ...
    private String rptHdnTxtRdoCaption[];
    ...
    private String fltrHdnTxtRdoCaption[];
    ...
    //for dependent combo fill
    private String fltrHdnCmbDependent;
    private String fltrHdnChkForDependentCombo[];
    ...
    public String[] getRptHdnTxtRdoCaption()
    {
        return rptHdnTxtRdoCaption;
    }

    public void setRptHdnTxtRdoCaption(String[] rptHdnTxtRdoCaption)
    {
        this.rptHdnTxtRdoCaption = rptHdnTxtRdoCaption;
    }

    public String[] getFltrHdnTxtRdoCaption()
    {
        return fltrHdnTxtRdoCaption;
    }

    public void setFltrHdnTxtRdoCaption(String[] fltrHdnTxtRdoCaption)
    {
        this.fltrHdnTxtRdoCaption = fltrHdnTxtRdoCaption;
    }

    public String getFltrHdnCmbDependent()
    {
        return fltrHdnCmbDependent;
    }

    public void setFltrHdnCmbDependent(String fltrHdnCmbDependent)
    {
        this.fltrHdnCmbDependent = fltrHdnCmbDependent;
    }

    public String[] getFltrHdnChkForDependentCombo()
    {
        return fltrHdnChkForDependentCombo;
    }

    public void setFltrHdnChkForDependentCombo(String[] fltrHdnChkForDependentCombo)
    {
        this.fltrHdnChkForDependentCombo = fltrHdnChkForDependentCombo;
    }
