...
import com.finlogic.business.finstudio.finreport.FinReportManager;
...
import com.finlogic.util.finreport.ReportGenerator;
import com.finlogic.util.finreport.ReportSRSGeneration;
...
public class FinReportService
{
    ...
    private final FinReportManager manager = new FinReportManager();

    public FinReportDetailEntityBean formBeanToDetailEntityBean(final FinReportFormBean formBean) throws SQLException
    {
        FinReportDetailEntityBean entityBean = new FinReportDetailEntityBean();
        ...
        entityBean.setHtml(formBean.isChkHtml());
    ...
    public FinReportSummaryEntityBean formBeanToSummaryEntityBean(final FinReportFormBean formBean)
    {
        FinReportSummaryEntityBean entityBean = new FinReportSummaryEntityBean();
    ...
    public int insertData(final FinReportFormBean formBean) throws SQLException, ClassNotFoundException, UnsupportedEncodingException
    {
    ...
    public String generateReportFiles(FinReportFormBean formBean) throws SQLException, ClassNotFoundException, FileNotFoundException, UnsupportedEncodingException
    {
        String str = "";
        if (formBean.getCmbRefNo() != null && !formBean.getCmbRefNo().equals(""))
        {
            FinReportDetailEntityBean dEntityBean = getDetailReportData(Integer.parseInt(formBean.getCmbRefNo()));
            dEntityBean.setSRNo(formBean.getSRNo());
            str = new ReportGenerator().generateReportFiles(dEntityBean, formBeanToSummaryEntityBean(formBean));
        ...
        {
            str = new ReportGenerator().generateReportFiles(formBeanToDetailEntityBean(formBean), null);
        }
        return str;
    }

    public String generateSRSFiles(FinReportFormBean formBean) throws SQLException, IOException, WriteException, ClassNotFoundException
    {
        String str = "";
        if (formBean.getCmbRefNo() != null && !formBean.getCmbRefNo().equals(""))
        {
            FinReportDetailEntityBean dEntityBean = getDetailReportData(Integer.parseInt(formBean.getCmbRefNo()));
            dEntityBean.setSRNo(formBean.getSRNo());
            str = new ReportSRSGeneration().writeSRS(dEntityBean, formBeanToSummaryEntityBean(formBean));
        }
        else
        {
            str = new ReportSRSGeneration().writeSRS(formBeanToDetailEntityBean(formBean), null);
        }
        return str;
    }
    ...
    public FinReportDetailEntityBean getDetailReportData(int srno) throws SQLException, ClassNotFoundException
    {
        FinReportDetailEntityBean entityBean = new FinReportDetailEntityBean();
