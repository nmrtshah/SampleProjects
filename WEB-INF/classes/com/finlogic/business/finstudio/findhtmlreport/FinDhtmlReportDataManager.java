 ...
 * @author njuser
 */
public class FinDhtmlReportDataManager
{
    ...
    public int insert(final FinDhtmlReportDetailEntityBean entityBean) throws ClassNotFoundException, SQLException, UnsupportedEncodingException
    {
        ...
        if (entityBean.isReportType() && entityBean.getRptControl() != null)
        {
            ...
            for (int i = 0; i < rptControlLen; i++)
            {
                ...
                insertIntoRptData("rptTxtRdoCaption", entityBean.getRptTxtRdoCaption()[i], idRptField);
        ...
        if (entityBean.isFilter() && entityBean.getFltrControl() != null)
        {
            ...
            for (int i = 0; i < filterControlLen; i++)
            {
                ...
                insertIntoRptData("fltrTxtRdoCaption", entityBean.getFltrTxtRdoCaption()[i], idRptField);
    ...
    public SqlRowSet getDetailReportData(int srno) throws ClassNotFoundException, SQLException
    {
        ...
        query.append("        IFNULL(GROUP_CONCAT(CASE WHEN RD.KEYNAME = 'rptTxtRdoCaption' THEN RD.VALUE ELSE NULL END),'') RPT_RADIO_CAPTION,");
        ...
        query.append("        IFNULL(GROUP_CONCAT(CASE WHEN RD.KEYNAME = 'fltrTxtRdoCaption' THEN RD.VALUE ELSE NULL END),'') FLTR_RADIO_CAPTION,");
        ...
        query.append("        IFNULL(GROUP_CONCAT(CASE WHEN RD.KEYNAME = 'fltrCmbDependent' THEN RD.VALUE ELSE NULL END),'') DEPENDENT_COMBO,");
        query.append("        IFNULL(GROUP_CONCAT(CASE WHEN RD.KEYNAME = 'fltrchkForDependentCombo' THEN RD.VALUE ELSE NULL END),'') FLTR_CHK_DEPENDENT_COMBO");
