 ...
 * @author njuser
 */
public class FinDhtmlReportDetailEntityBean
{
    //Project Spec 
    ...
    private String rptTxtRdoCaption[];
    ...
    private String fltrTxtRdoCaption[];
    ...
    //for dependent combo
    private String fltrCmbDependent;
    private String fltrchkForDependentCombo[];
    //for chart
    ...
    public String[] getRptTxtRdoCaption()
    {
        return rptTxtRdoCaption;
    }

    public void setRptTxtRdoCaption(String[] rptTxtRdoCaption)
    {
        this.rptTxtRdoCaption = rptTxtRdoCaption;
    }

    public String[] getFltrTxtRdoCaption()
    {
        return fltrTxtRdoCaption;
    }

    public void setFltrTxtRdoCaption(String[] fltrTxtRdoCaption)
    {
        this.fltrTxtRdoCaption = fltrTxtRdoCaption;
    }

    public String getFltrCmbDependent()
    {
        return fltrCmbDependent;
    }

    public void setFltrCmbDependent(String fltrCmbDependent)
    {
        this.fltrCmbDependent = fltrCmbDependent;
    }

    public String[] getFltrchkForDependentCombo()
    {
        return fltrchkForDependentCombo;
    }

    public void setFltrchkForDependentCombo(String[] fltrchkForDependentCombo)
    {
        this.fltrchkForDependentCombo = fltrchkForDependentCombo;
    } 
}
