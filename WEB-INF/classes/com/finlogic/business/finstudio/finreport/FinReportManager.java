...
public class FinReportManager
{
    ...
    private final FinReportDataManager datamgr = new FinReportDataManager();

    public int insert(final FinReportDetailEntityBean entity) throws ClassNotFoundException, SQLException, UnsupportedEncodingException
    {
