...
public class FinStatistics
{
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException
    {
        ...
        obj.updateRGV2_Statistics();
        obj.updateRGV3_Statistics();
        obj.updateMGV2_Statistics();
        obj.updateWSGEN_Statistics();
        obj.updateORATOSQL_Statistics();

        obj.finFileTransferTotalReqExecuted();
        obj.finFileTransferTop3Users();
        obj.finFileTransferTop3Projects();

        obj.updateDRETotalReqExecuted();
        obj.updateDRETop3Users();
        obj.updateDRETop3Projects();
    }

    private void updateRGV2_Statistics() throws ClassNotFoundException, SQLException
    {
        ...
        if (srs != null && srs.next())
        {
            ...
            while (srs.next())
            {
                ...
                if (strGrpName.equalsIgnoreCase("Report Generation V2") && strStatsName.equalsIgnoreCase("RGV2 Detail"))
                {
                    ...
                    query.append(result);
                    query.append("', ON_DATE = SYSDATE() WHERE SRNO =");
        ...
        query.setLength(0);
        query.append("SELECT IFNULL(ROUND(COUNT(REQUEST_URL)/COUNT(DISTINCT DATE_FORMAT(ENTDATE,'%d/%m/%Y'))),-1) AVG_HITS_PER_DAY");
        query.append(" FROM SERVER_ACCESS_AUDIT ");
        query.append(" WHERE PROJECT_NAME = 'finstudio' ");
        query.append(" AND REQUEST_URL = '/finstudio/repgenv2.fin'");
        query.append(" AND REQUEST_PARAMS LIKE '%cmdAction=setFinish%'");
        query.append(" AND HTTPSTATUS = 200");

        result = "";
        List lst = SqlUtil.getList(ALIASNAME, query.toString());

        if (lst!=null && lst.size()>0)
        {
            Map m = (Map) lst.get(0);
            int hits = Integer.valueOf(m.get("AVG_HITS_PER_DAY").toString());
            if(hits>0)
            {
                result = "Average "+hits+" Hits are recorded per day for Report Generation V2 (JqGrid)";
                query.setLength(0);
                query.append("SELECT SRNO, COUNT(SRNO) CNT ");
                query.append(" FROM FINSTUDIO_STATISTICS ");
                query.append(" WHERE GROUP_NAME = 'Report Generation V2' ");
                query.append(" AND STATS_NAME = 'RGV2 Hits count'");

                List lst2 = SqlUtil.getList(ALIASNAME, query.toString());
                if(lst2!=null&&lst2.size()>0)
                {
                    Map m2 = (Map) lst2.get(0);
                    if(Integer.valueOf(m2.get("CNT").toString())==1 && m2.get("SRNO")!=null)
                    //UPDATE
                    {
                        query.setLength(0);
                        query.append("UPDATE FINSTUDIO_STATISTICS SET STATS = ").append(hits).append(",STATS_STRING = '");
                        query.append(result);
                        query.append("', ON_DATE = SYSDATE() WHERE SRNO =");
                        query.append(m2.get("SRNO").toString());
                        SqlUtil.persist(ALIASNAME, query.toString());
                    }
                    else
                    //INSERT
                    {
                        query.setLength(0);
                        query.append("INSERT INTO FINSTUDIO_STATISTICS (GROUP_NAME,STATS_NAME,STATS,STATS_STRING,ON_DATE,IS_ACTIVE) VALUES(");
                        query.append("'Report Generation V2','RGV2 Hits count',").append(hits).append(",'");
                        query.append(result);
                        query.append("',SYSDATE(),'Y')");
                        SqlUtil.persist(ALIASNAME, query.toString());
                    }
    ...
    private void updateRGV3_Statistics() throws ClassNotFoundException, SQLException
    {
        StringBuilder query = new StringBuilder();
        ...
        query.append(" FROM SERVER_ACCESS_AUDIT ");
        query.append(" WHERE PROJECT_NAME = 'finstudio' ");
        query.append(" AND REQUEST_URL = '/finstudio/repgenv3.fin'");
        query.append(" AND REQUEST_PARAMS LIKE '%cmdAction=setFinish%'");
        query.append(" AND HTTPSTATUS = 200");
        ...
        if (lst!=null && lst.size()>0)
        {
            ...
            if(hits>0)
            {
                result = "Average "+hits+" Hits are recorded per day for Report Generation V3 (DHTMLx)";
                query.setLength(0);
                query.append("SELECT SRNO, COUNT(SRNO) CNT ");
                query.append(" FROM FINSTUDIO_STATISTICS ");
                query.append(" WHERE GROUP_NAME = 'Report Generation V3' ");
                query.append(" AND STATS_NAME = 'RGV3 Hits count'");
                ...
                if(lst2!=null&&lst2.size()>0)
                {
                    ...
                    //INSERT
                    {
                        query.setLength(0);
                        query.append("INSERT INTO FINSTUDIO_STATISTICS (GROUP_NAME,STATS_NAME,STATS,STATS_STRING,ON_DATE,IS_ACTIVE) VALUES(");
                        query.append("'Report Generation V3','RGV3 Hits count',").append(hits).append(",'");
                        query.append(result);
                        query.append("',SYSDATE(),'Y')");
                        SqlUtil.persist(ALIASNAME, query.toString());
                    }
    ...
    private void updateMGV2_Statistics() throws ClassNotFoundException, SQLException
    {
        StringBuilder query = new StringBuilder();
        ...
        if (srs != null && srs.next())
        {
            ...
            while (srs.next())
            {
                ...
                if (strGrpName.equalsIgnoreCase("Master Generation V2") && strStatsName.equalsIgnoreCase("MGV2 Detail"))
                {
                    ...
                    query.append("SET STATS = 0, STATS_STRING = '").append(result).append("', ON_DATE = SYSDATE() ");
        ...
        query.append(" FROM SERVER_ACCESS_AUDIT ");
        query.append(" WHERE PROJECT_NAME = 'finstudio' ");
        query.append(" AND REQUEST_URL = '/finstudio/mstgenv2.fin'");
        query.append(" AND REQUEST_PARAMS LIKE '%cmdAction=setFinish%'");
        query.append(" AND HTTPSTATUS = 200");
        ...
        if (lst!=null && lst.size()>0)
        {
            ...
            if(hits>0)
            {
                result = "Average "+hits+" Hits are recorded per day for Master Generation V2";
                query.setLength(0);
                query.append("SELECT SRNO, COUNT(SRNO) CNT ");
                query.append(" FROM FINSTUDIO_STATISTICS ");
                query.append(" WHERE GROUP_NAME = 'Master Generation V2' ");
                query.append(" AND STATS_NAME = 'MGV2 Hits count'");
                ...
                if(lst2!=null&&lst2.size()>0)
                {
                    ...
                    //INSERT
                    {
                        query.setLength(0);
                        query.append("INSERT INTO FINSTUDIO_STATISTICS (GROUP_NAME,STATS_NAME,STATS,STATS_STRING,ON_DATE,IS_ACTIVE) VALUES(");
                        query.append("'Master Generation V2','MGV2 Hits count',").append(hits).append(",'");
                        query.append(result);
                        query.append("',SYSDATE(),'Y')");
                        SqlUtil.persist(ALIASNAME, query.toString());
                    }
    ...
    private void updateWSGEN_Statistics() throws ClassNotFoundException, SQLException
    {
        StringBuilder query = new StringBuilder();
        ...
        query.append(" FROM SERVER_ACCESS_AUDIT ");
        query.append(" WHERE PROJECT_NAME = 'finstudio' ");
        query.append(" AND REQUEST_URL = '/finstudio/webservicegen.fin'");
        query.append(" AND REQUEST_PARAMS LIKE '%cmdAction=onFinish%'");
        query.append(" AND HTTPSTATUS = 200");
        ...
        if (lst!=null && lst.size()>0)
        {
            ...
            if(hits>0)
            {
                result = "Average "+hits+" Hits are recorded per day for Web Service Generation";
                query.setLength(0);
                query.append("SELECT SRNO, COUNT(SRNO) CNT ");
                query.append(" FROM FINSTUDIO_STATISTICS ");
                query.append(" WHERE GROUP_NAME = 'Web Service Generation' ");
                query.append(" AND STATS_NAME = 'WSGEN Hits count'");
                ...
                if(lst2!=null&&lst2.size()>0)
                {
                    ...
                    //INSERT
                    {
                        query.setLength(0);
                        query.append("INSERT INTO FINSTUDIO_STATISTICS (GROUP_NAME,STATS_NAME,STATS,STATS_STRING,ON_DATE,IS_ACTIVE) VALUES(");
                        query.append("'Web Service Generation','WSGEN Hits count',").append(hits).append(",'");
                        query.append(result);
                        query.append("',SYSDATE(),'Y')");
                        SqlUtil.persist(ALIASNAME, query.toString());
                    }
    ...
    private void updateORATOSQL_Statistics() throws ClassNotFoundException, SQLException
    {
        ...
        query.append(" FROM SERVER_ACCESS_AUDIT ");
        query.append(" WHERE PROJECT_NAME = 'finstudio' ");
        query.append(" AND REQUEST_URL = '/finstudio/oracleToMySql.fin'");
        query.append(" AND REQUEST_PARAMS LIKE '%cmdAction=getNewQuery%'");
        query.append(" AND HTTPSTATUS = 200");
        ...
        if (lst!=null && lst.size()>0)
        {
            ...
            if(hits>0)
            {
                result = "Average "+hits+" Hits are recorded per day for Oracle to Mysql Utility";
                query.setLength(0);
                query.append("SELECT SRNO, COUNT(SRNO) CNT ");
                query.append(" FROM FINSTUDIO_STATISTICS ");
                query.append(" WHERE GROUP_NAME = 'Oracle To Mysql' ");
                query.append(" AND STATS_NAME = 'OracToMysql Hits count'");
                ...
                if(lst2!=null&&lst2.size()>0)
                {
                    ...
                    //INSERT
                    {
                        query.setLength(0);
                        query.append("INSERT INTO FINSTUDIO_STATISTICS (GROUP_NAME,STATS_NAME,STATS,STATS_STRING,ON_DATE,IS_ACTIVE) VALUES(");
                        query.append("'Oracle To Mysql','OracToMysql Hits count',").append(hits).append(",'");
                        query.append(result);
                        query.append("',SYSDATE(),'Y')");
                        SqlUtil.persist(ALIASNAME, query.toString());
                    }
    ...
    private void finFileTransferTotalReqExecuted() throws ClassNotFoundException, SQLException
    {
        Map map = new HashMap();
        String desc = "";
        String avgDesc = "";
        ...
        query.append(" FROM SERVER_ACCESS_AUDIT ");
        query.append(" WHERE PROJECT_NAME = 'finstudio' ");
        query.append(" AND REQUEST_URL = '/finstudio/view_finfiletransfer.fin'");
        query.append(" AND REQUEST_PARAMS LIKE '%cmdAction=execute%'");
        query.append(" AND HTTPSTATUS = 200");
        ...
        if (lst!=null && lst.size()>0)
        {
            ...
            if(hits>0)
            {
                result = "Average "+hits+" Hits are recorded per day for Fin File Transfer Utility";
                query.setLength(0);
                query.append("SELECT SRNO, COUNT(SRNO) CNT ");
                query.append(" FROM FINSTUDIO_STATISTICS ");
                query.append(" WHERE GROUP_NAME = 'Fin File Deployment' ");
                query.append(" AND STATS_NAME = 'Fin File Deployment Detail6'");
                ...
                if(lst2!=null&&lst2.size()>0)
                {
                    ...
                    //INSERT
                    {
                        query.setLength(0);
                        query.append("INSERT INTO FINSTUDIO_STATISTICS (GROUP_NAME,STATS_NAME,STATS,STATS_STRING,ON_DATE,IS_ACTIVE) VALUES(");
                        query.append("'Fin File Deployment','Fin File Deployment Detail6',").append(hits).append(",'");
                        query.append(result);
                        query.append("',SYSDATE(),'Y')");
                        SqlUtil.persist(ALIASNAME, query.toString());
                    }
    ...
    private void finFileTransferTop3Users() throws ClassNotFoundException, SQLException
    {
        StringBuilder SQL = new StringBuilder();
        SQL.setLength(0);
        ...
        SqlUtil.persist(ALIASNAME, SQL.toString());
    }

    private void finFileTransferTop3Projects() throws ClassNotFoundException, SQLException
    {
        StringBuilder SQL = new StringBuilder();
    ...
    private void updateDRETotalReqExecuted() throws ClassNotFoundException, SQLException
    {
        Map map = null;
        String desc = "";
        String avgDesc = "";
        ...
        query.append(" FROM SERVER_ACCESS_AUDIT ");
        query.append(" WHERE PROJECT_NAME = 'finstudio' ");
        query.append(" AND REQUEST_URL = '/finstudio/exec_findatareqexec.fin'");
        query.append(" AND REQUEST_PARAMS LIKE '%cmdAction=executeRequest%'");
        query.append(" AND HTTPSTATUS = 200");
        ...
        if (lst!=null && lst.size()>0)
        {
            ...
            if(hits>0)
            {
                result = "Average "+hits+" Hits are recorded per day for Data Request Executor";
                query.setLength(0);
                query.append("SELECT SRNO, COUNT(SRNO) CNT ");
                query.append(" FROM FINSTUDIO_STATISTICS ");
                query.append(" WHERE GROUP_NAME = 'Data Request Executor' ");
                query.append(" AND STATS_NAME = 'Data Request Executor Detail6'");
                ...
                if(lst2!=null&&lst2.size()>0)
                {
                    ...
                    //INSERT
                    {
                        query.setLength(0);
                        query.append("INSERT INTO FINSTUDIO_STATISTICS (GROUP_NAME,STATS_NAME,STATS,STATS_STRING,ON_DATE,IS_ACTIVE) VALUES(");
                        query.append("'Data Request Executor','Data Request Executor Detail6',").append(hits).append(",'");
                        query.append(result);
                        query.append("',SYSDATE(),'Y')");
                        SqlUtil.persist(ALIASNAME, query.toString());
                    }
    ...
    private void updateDRETop3Users() throws ClassNotFoundException, SQLException
    {
        StringBuilder SQL = new StringBuilder();
        SQL.setLength(0);
    ...
    private void updateDRETop3Projects() throws ClassNotFoundException, SQLException
    {
        StringBuilder SQL = new StringBuilder();
