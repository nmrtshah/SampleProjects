 ...
 * @author Sonam Patel
 */
public class MasterJSONOutPutGenerator
{

    public void generateMasterJSONOutPut(final FinMasterFormBean formBean) throws FileNotFoundException
    {
        String projectName;
        ...
        file.mkdirs();
        PrintWriter pw;
        pw = new PrintWriter(projectPath + "output.jsp");
