 ...
 * @author njuser
 */
public class ReportFormBeanGenerator
{

    public void generateReportFormBean(final FinReportDetailEntityBean dEntityBean, final FinReportSummaryEntityBean sEntityBean) throws FileNotFoundException
    {
        ...
        if (dEntityBean.isReportType())
        {
            /*for (String inputName : rptFields)
             {
             String methodName = inputName.substring(0, 1).toUpperCase(Locale.getDefault()) + inputName.substring(1).toLowerCase(Locale.getDefault());
             pw.println("    public String get" + methodName + "()");
             pw.println("    {");
             //pw.println("        return " + inputName.toLowerCase(Locale.getDefault()) + ";");
             pw.println("        return " + inputName + ";");
             pw.println("    }");
             pw.println();

             pw.println("    public void set" + methodName + "(final String " + inputName.toLowerCase(Locale.getDefault()) + "Var)");
             pw.println("    {");
             //pw.println("        " + inputName.toLowerCase(Locale.getDefault()) + " = " + inputName.toLowerCase(Locale.getDefault()) + "Var;");
             pw.println("        " + inputName + " = " + inputName.toLowerCase(Locale.getDefault()) + "Var;");
             pw.println("    }");
             pw.println();
             }*/
            for (int i = 0; i < rptFields.length; i++)
