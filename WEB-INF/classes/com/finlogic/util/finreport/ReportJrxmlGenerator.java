...
public class ReportJrxmlGenerator
{
    ...
    public void generateReportJrxml(final FinReportDetailEntityBean dEntityBean, final FinReportSummaryEntityBean sEntityBean) throws FileNotFoundException
    {        
        ...
        boolean Grouping = dEntityBean.isGrouping();
        boolean GroupFooter = dEntityBean.isGroupFooter();
        String GroupField = dEntityBean.getGroupField();
        String[] FooterColumn = dEntityBean.getGroupFtrCol();
        String[] FooterColumnCalc = dEntityBean.getGroupFtrCal();
        String[] tabColumns = dEntityBean.getSelectedColumns();
        int tabColumnLen = tabColumns.length;
        String[] allColumns = dEntityBean.getAllColumns();
        int allColumnLen = allColumns.length;
        String[] allColumnTypes = dEntityBean.getAllColumnTypes();
        ...
        pw.println("            <staticText>");
        pw.println("                <reportElement mode=\"Opaque\" x=\"420\" y=\"20\" width=\"" + (dEntityBean.getReportTitle().length() * 12) + "\" height=\"20\"/>");
        ...
        pw.println("                    </textElement>");
        pw.println("                <text><![CDATA[" + dEntityBean.getReportTitle() + "]]></text>");
        pw.println("            </staticText>");
        pw.println("        </band>");
        pw.println("    </title>");
        ...
        String[] colNames = new String[dEntityBean.getSelectedColumns().length];
        System.arraycopy(dEntityBean.getSelectedColumns(), 0, colNames, 0, dEntityBean.getSelectedColumns().length);
        ...
        for (int i = 0; i < colNames.length; i++)
        {
            ...
            if (colNames[i].contains("_"))
            {
                ...
                StringBuilder tmpstr = new StringBuilder(colNames[i].toLowerCase(Locale.getDefault()));
                int j = 0;
                do
                {
