 ...
 * @author njuser
 */
public class ReportSRSGeneration
{
    ...
    public ReportSRSGeneration() throws WriteException
    {
     ...
     public String writeSRS(final FinReportDetailEntityBean dEntityBean, final FinReportSummaryEntityBean sEntityBean) throws IOException, WriteException
    {
    ...
    private void srsSpecification(final FinReportDetailEntityBean entityBean) throws WriteException
    {
    ...
    private void writeSpec(final FinReportDetailEntityBean entityBean, final String tabname) throws WriteException
    {
        int field_len = 0;
