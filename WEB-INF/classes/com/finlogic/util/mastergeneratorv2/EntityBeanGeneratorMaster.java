 ...
 * @author njuser
 */
public class EntityBeanGeneratorMaster
{

    public EntityBeanGeneratorMaster(MasterGeneratorV2FormBean formBean) throws Exception
    {
    ...
    public void generateEntityBean(MasterGeneratorV2FormBean formBean) throws Exception
    {
        ...
        file.mkdirs();
        PrintWriter pw = new PrintWriter(projectPath + moduleName + "EntityBeanMaster.java");

        pw.println("package com.finlogic.business." + formBean.getProjectName().toLowerCase() + ".entitybeans;");

        pw.println("public class " + moduleName + "EntityBeanMaster ");
        pw.println("{");
        ArrayList<String> allColumns = formBean.getMasterColumns();
