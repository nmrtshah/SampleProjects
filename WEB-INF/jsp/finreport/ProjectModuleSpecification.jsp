                    ...
                    <div class="menu_new">
                        ...
                        <table align="center" width="100%" id="tblprojectmodule">
                            <tr style="border-bottom: red;border-style: solid">
                                ...
                                <td width="30%">
                                    <select id="cmbProjectName" name="cmbProjectName" tabindex="1" onchange="getRefNumber()">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="cmbRefNo" name="cmbRefNo" tabindex="2">
                                        <option value="1">-- Select Reference Number --</option>
                                    </select>
                                </td>
                                    ...
                                    <table align="center" cellspacing="2" cellpadding="0" border="0" width="100%" >
                                        <tr>
                                            ...
                                            <td width="60%">
                                                ...
                                                <input type="checkbox" id="chkHtml" name="chkHtml">Html
                                            </td>
                                        </tr>
