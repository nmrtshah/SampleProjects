...
function getColumnDetails()
{
    if(document.getElementById("divresult").innerHTML.match("Invalid Alias or Query") == null)
    {
        ...
        getData_sync("repgenv2.fin?cmdAction=getColumnDetail", "divqueryresult", params, false);
...
function getMainQueryColumns()
{
    ...
    {
        getDataFilterNew("repgenv2.fin?cmdAction=getColumnNames", "cmbTempColResult", params, false);
    ...
    else
    {
        ...
        //document.getElementById('cmbAliasName').focus();
        //document.getElementsByName("txtQuery")[0].focus();
        }
    }
}
...
{    
    ...
    for(var i = 1; i < len; i++)
    {
        if(document.getElementsByName("txtQuery").item(i) == elem)
        {
            ...
            if(checkQuery(params))
            {
                getDataFilterNew("repgenv2.fin?cmdAction=getColumnNames", "cmbChildQueryColumn", params, false);
                return true;
            }
        }
    }
...
function checkQuery(params)
{
    ...
    else if(str.toLowerCase().match("where rownum") == null && str.toLowerCase().match("limit") == null)
    {
        ...
        if (ans == true)
        {
            getData_sync("repgenv2.fin?cmdAction=checkQuery", "divresult", params, false);
            if(document.getElementById("divresult").innerHTML.match("Invalid Alias or Query") == null)
            {
                return true;
            }
...
function onAdd()
{
    ...
    {
        if(document.getElementById('cmbGrpFooterCalculation').value == "count")
        {
...
function onFinish()
{
    ...
    var params=getFormData(document.MenuForm);
    getData_sync("repgenv2.fin?cmdAction=setFinish", "divFinish", params, false);
...
{    
    ...
    document.getElementById(tabnm+"TxtRdoDefVal").value = document.getElementById(editdivid).childNodes[21].value;         
    if(tabnm == "fltr")
    {
        ...
        //        }
        if(document.getElementById(editdivid).childNodes[22].value == "true")
        {
        ...
        if(document.getElementById(editdivid).childNodes[23].value == "fltrCmbSrcStatic")
        {            
            document.getElementById(tabnm+"RdoSrcStatic").checked = true;
        }
        else if(document.getElementById(editdivid).childNodes[23].value == "fltrCmbSrcQuery")
        {
            document.getElementById(tabnm+"RdoSrcQuery").checked = true;
        }
        else if(document.getElementById(editdivid).childNodes[23].value == "fltrCmbSrcWS")
        {
            document.getElementById(tabnm+"RdoSrcWS").checked = true;
        }
        else if(document.getElementById(editdivid).childNodes[23].value == "fltrCmbSrcCommonCmb")
        {
        ...
        document.getElementById(tabnm+"TxtSrcQuery").value = unescape(document.getElementById(editdivid).childNodes[24].value);
        document.getElementById(tabnm+"TxtSrcStatic").value = document.getElementById(editdivid).childNodes[25].value;        
        
        document.getElementById(tabnm+"TxtWsdlUrl").value = document.getElementById(editdivid).childNodes[26].value;        
        document.getElementById(tabnm+"CmbWsMethod").value = document.getElementById(editdivid).childNodes[27].value;        
        document.getElementById(tabnm+"WSCmbValue").value = document.getElementById(editdivid).childNodes[28].value;        
        document.getElementById(tabnm+"WSCmbText").value = document.getElementById(editdivid).childNodes[29].value;            
                
        if(document.getElementById(tabnm+"chkDataSource").checked && document.getElementById(tabnm+"RdoSrcWS").checked)
        {
            document.getElementById(tabnm+"TxtWsProject").value = document.getElementById(editdivid).childNodes[30].value;        
            document.getElementById(tabnm+"TxtWsIntrface").value = document.getElementById(editdivid).childNodes[31].value;        
            document.getElementById(tabnm+"TxtWsRetType").value = document.getElementById(editdivid).childNodes[32].value;        
            document.getElementById(tabnm+"TxtWsParams").value = document.getElementById(editdivid).childNodes[33].value;      
            document.getElementById(tabnm+"TxtWsExps").value = document.getElementById(editdivid).childNodes[34].value;      
        } 
        
        document.getElementById(tabnm+"CmbCommonQuery").value = document.getElementById(editdivid).childNodes[35].value;            
    } 
    validateControl(tabnm);
...
function validateNoOfRadio(tabnm)
{
    if(document.getElementById(tabnm+"CmbControl").value == "Radio" )
    {
        ...
        else if (document.getElementById(tabnm+"TxtRdoVal").value == "")
        {
...
function validateComboFill(tabnm)
{
    if(document.getElementById(tabnm+"CmbControl").value == "ComboBox" || document.getElementById(tabnm+"CmbControl").value == "TextLikeCombo")
    {
        ...
        {
            var params=getFormData(document.MenuForm);
            getData_sync("repgenv2.fin?cmdAction=comboFillCheckQuery", "cmbFillQueryResult", params, false);
...
function setGroupFooterCalc()
{
    ...
    combo.innerHTML += "<option value=\"sum\">Sum</option>";
    combo.innerHTML += "<option value=\"average\">Average</option>";
    combo.innerHTML += "<option value=\"lowest\">Minimum</option>";
    combo.innerHTML += "<option value=\"highest\">Maximum</option>";
    combo.innerHTML += "<option value=\"count\">Count</option>";
}
...
function getRefNumber()
{
    ...
    {
        var params=getFormData(document.MenuForm);
        getDataFilterNew("repgenv2.fin?cmdAction=getRefNumber", "cmbRefNo", params, false);
    }
}
...
function getWsdlMethods(tabnm)
{
    ...
    var params = getFormData(document.MenuForm);
    getSynchronousData("repgenv2.fin?cmdAction=getWsDetails", params, "fltrtdWsdl");
    ...
    else
    {
        ...
        getSynchronousData("repgenv2.fin?cmdAction=getWsMethods", params, "fltrtdWsdl");
...
function getWsMethodParams(tabnm)
{
    ...
    {        
        var params = getFormData(document.MenuForm);
        getSynchronousData("repgenv2.fin?cmdAction=getWsMethodParams", params, "fltrtdWsdl");
    }
}